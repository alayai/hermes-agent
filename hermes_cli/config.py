...
DEFAULT_CONFIG = {
    ...
    # Elite enterprise backend connection settings.
    # Env vars (ELITE_BASE_URL, ELITE_API_TOKEN) take precedence over these.
    "elite": {
        "base_url": "",  # Elite backend URL (fallback if ELITE_BASE_URL not set)
        "doc_service_url": "",  # Doc service URL (fallback if ELITE_DOC_SERVICE_URL not set)
    },
...
OPTIONAL_ENV_VARS = {
    ...
    "ELITE_API_TOKEN": {
        "description": "Elite API token (long-lived service token for backend access)",
    ...
    "ELITE_USERNAME": {
        "description": "Elite username (alternative to API token for credential-based auth)",
