...
_HERMES_CORE_TOOLS = [
    ...
    "ha_list_services",
    "ha_call_service",
    # Elite enterprise backend (gated on ELITE_API_TOKEN via check_fn)
    "elite_rag_search",
    "elite_rag_query",
    "elite_kb_list",
    "elite_workflow_list",
...
TOOLSETS = {
    ...
    "elite": {
        "description": "Elite enterprise backend tools (RAG knowledge base, workflow execution, tables, agents)",
        "tools": [
            "elite_rag_search",
            "elite_rag_query",
            "elite_kb_list",
